...
class SelectMasterThailife extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        let treeData = _.orderBy(_.filter(CALENDAR_MASTER_BRANCH_LOCATION_DATA, { BranchType: 'TL' }), ['RegionID', 'AreaID', 'ZoneValue']).map((item, index) => {
            return {
